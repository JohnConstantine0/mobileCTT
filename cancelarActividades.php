...
<div data-role="page" id="pageone">
    ...
    <div data-role="navbar">
      <ul>
        <li><a href="inscribirActividades.php">Agendar Acts</a></li>
        <li><a href="#" class="ui-btn-active">Mis Acts</a></li>
  ...
  <div data-role="main" class="ui-content">
    ...
    <form method="post" action="">
      <h2>Cancelar Actividades</h2>
    </form>
	<br>

 <div class="container" id="cancelaractsAgendadas"><?php Include('php/consultaactsagendadasParticipante.php'); ?></div>
